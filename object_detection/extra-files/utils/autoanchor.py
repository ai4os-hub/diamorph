...
def rotate_kmean_anchors(
    path="./data/rotate_coco.yaml", n=9, img_size=640, thr=4.0, gen=1000, verbose=True
):
    ...
    if isinstance(path, str):  # *.yaml file
        ...
        dataset = Rotate_LoadImagesAndLabels(
